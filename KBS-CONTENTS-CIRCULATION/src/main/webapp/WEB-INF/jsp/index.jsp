...
<body>
				...
				<div class="login-bx" id="login">
					<div class="login-box">
						...
						<div class="mb-bx">
							...
							<div class="log-txt">
								<p class="title">Administrator System</p>
								<input type="radio" id="loginType1" name=loginType value='01'/><label for="loginType1" class="ml0"><span></span>관리자</label>
								<input type="radio" id="loginType2" name=loginType value='02'/><label for="loginType2" class="ml0"><span></span>사용자</label>
							</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("input[name=loginType]").eq(1).attr("checked", true);
