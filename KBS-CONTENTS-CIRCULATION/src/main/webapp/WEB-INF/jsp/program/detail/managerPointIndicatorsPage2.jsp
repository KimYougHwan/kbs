	...
	<body>
		<div id="wrap">
			...
			<div id="container">
				...
				<div class="nav">Home &gt; 프로그램 상세  &gt;<span>주요지표-단일회차</span></div>
				<div id="contents">
					<div class="content-bx">
						<h3 class="depth5">프로그램 상세-주요지표 조회</h3>
						<div class="search-bx">
							<ul>
								<li><span>01</span><label for="sch-pr02" class="wx100 txt-l">프로그램 명</label>
									<ul>
										<li>
								...
								<li><span>02</span><label for="vodcnt" class="wx100 txt-l">회차 정보</label>
									<ul>
										<li>
								...
								<li><span>03</span><label for="addDay" class="wx100 txt-l">기간 선택</label>
									<ul>
										<li>
		...
		$(document).ready(function() {
			...
			$("#programBtn").click(function() {
		 	...
		 	$("#excelBtn").click(function() {
				...
				broadDate = broadDate.replace(/-/gi, '');
				if(searchValue > searchValue2) {
					alert('시작일이 종료일보다 클 수 없습니다.');
					return;
				}		
				location.href = '/program/detail/point/downloadExcelFile?searchType=02&searchValue='+searchValue+'&searchValue2='+searchValue2+'&broadDate='+broadDate+'&pSeq='+pSeq;
			});
			...
			function search() {
				...
				$.ajax({
					type :	"get",
					url  : 	'/program/detail/getProgramPointIndicatorsList2',
					datatype : "json",
					async: true,
					data: {
						pSeq : pSeq,
